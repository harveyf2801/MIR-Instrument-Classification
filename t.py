...
for filename in os.listdir(audio_folder):
  if filename.endswith(".wav"):
    ...
    fixed_length = 44100  # Assuming a fixed length of 1 second (44100 samples at 44.1 kHz)
...
# mfcc_features_pca, _ = data_anaysis.pca(mfcc_features_scaled, 100)
# mfcc_features_pca = mfcc_features_pca.T
...
for label in unique_labels:
  ...
  plt.scatter(mfcc_features_pca[indices, 0], mfcc_features_pca[indices, 1], label=label)
